...
- In the terminal type in a Pokemon to retreive its data using the format 'python main.py <pokemon-name>' on Windows or 'python3 main.py <pokemon-name>' on Mac. For example - 'python3 main.py pikachu'. If the wrong format is used this will give an error message. 
